function p_h = plot_centre_of_mass_settling_interior(multi_plot)
% plot the centre of mass of the interior particles over time
...
[time,x_com,y_com,z_com] = particle_centre_of_mass_interior();
